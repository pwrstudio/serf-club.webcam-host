  ...
  start: function start () {
    Sentencer.configure({
      ...
      actions: {
        ...
        statement: function () {
          return vocabulary.statements[Math.round(Math.random() * (vocabulary.statements.length - 1))]
        },
        question: function () {
          return vocabulary.questions[Math.round(Math.random() * (vocabulary.questions.length - 1))]
        },
        punctation: function () {
          return vocabulary.punctations[Math.round(Math.random() * (vocabulary.punctations.length - 1))]
        },
        adverb: function () {
